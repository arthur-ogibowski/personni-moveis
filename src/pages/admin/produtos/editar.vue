            ...
            <div class="criar-content" v-if="product.editable">
                ...
                <div class="elements">
                    <div class="element-item" v-for="section in product.sections" v-bind:key="section">
                        ...
                        <div class="element-card">
                            <el-icon v-on:click="removeSection(product.sections, section)" style="margin-right:-5px; float: right; margin-top: 10px; cursor: pointer;" :size="20" color="#FF0000"><CloseBold /></el-icon>
